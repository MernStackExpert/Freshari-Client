...
const AdminLoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        Cookies.set("Arshe-Mart_admin_token", res.data.token, { expires: 7 });
        Cookies.set("admin_user", JSON.stringify(res.data.user), {
          expires: 7,
        });
        toast.success("Welcome Back to Arshe-Mart!");
        router.push("/admin");
        router.refresh();
      }
    } catch (error) {
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white tracking-tighter uppercase mb-2">
            Arshe-Mart <span className="text-[#22C55E]">ADMIN</span>
          </h1>
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <input
                ...
                placeholder="admin@Arshe-Mart.com"
