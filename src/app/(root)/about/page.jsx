  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-base-100 via-base-200 to-base-100 overflow-hidden">
      ...
      <div className="relative py-28 bg-gradient-to-br from-primary via-primary to-secondary text-primary-content overflow-hidden">
        ...
        >
          ...
          <p className="text-2xl md:text-3xl max-w-4xl mx-auto leading-tight opacity-90 font-light">
            বিশুদ্ধতা যেখানে শুরু হয় —{" "}
            <span className="font-semibold">আপনার রান্নাঘর থেকে</span>
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div variants={fadeInUp} className="space-y-8">
            ...
            <p className="text-lg leading-relaxed text-base-content/80 max-w-lg">
              Arshe-Mart শুরু হয়েছিল একটি সাধারণ স্বপ্ন নিয়ে — প্রতিটি বাংলাদেশি
              পরিবারের রান্নাঘরে খাঁটি, ফ্রেশ এবং নিরাপদ পণ্য পৌঁছে দেওয়া।
            </p>
            ...
            <div className="relative bg-base-100 rounded-3xl p-12 shadow-2xl border border-base-200 overflow-hidden">
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                ...
                <p className="text-base-content/70 max-w-xs">
                  আমাদের প্রতিটি পণ্যের পিছনে আছে কঠোর মান নিয়ন্ত্রণ এবং সরাসরি
                  উৎস।
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            {[
              ...
              >
                <div
                  className={`w-20 h-20 rounded-2xl bg-${item.color}/10 flex items-center justify-center mb-8 group-hover:bg-${item.color}/20 transition-colors text-${item.color}`}
                >
                  {item.icon}
                </div>
      ...
      >
        ...
        <p className="text-xl text-base-content/60 mb-16">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            {
              icon: <FaHandsHelping className="text-5xl text-blue-500" />,
              label: "২৪/৭ সাপোর্ট",
            },
            {
              icon: <FaUsers className="text-5xl text-violet-500" />,
              label: "দক্ষ ডেলিভারি",
            },
            {
